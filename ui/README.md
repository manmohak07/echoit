...
This is the frontend UI for the Echoit peer-to-peer file sharing application. It's built with Next.js, TypeScript, and Tailwind CSS.
...
mvn clean package
java -jar target/echoit-1.0-SNAPSHOT.jar
```
